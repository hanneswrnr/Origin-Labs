            ...
            <h2 className="text-xl font-bold text-white mb-8 font-montserrat flex items-center gap-3">
              ...
              <div className="space-y-6">
                <div className="relative group">
                  <label className="block text-sm font-semibold text-slate-200 mb-2">Firmenname</label>
                  <input
                    type="text"
                    value={form.companyName}
                    onChange={(e) => handleChange("companyName", e.target.value)}
                    className="w-full px-5 py-4 bg-slate-grey/5 dark:bg-white/5 border-2 border-white/10 rounded-2xl
                               ...
                               placeholder:text-slate-grey/30 dark:placeholder:text-slate-500 text-white"
                  />
                </div>
                ...
                <div className="relative group">
                  <label className="block text-sm font-semibold text-slate-200 mb-2">Straße & Hausnummer</label>
                  <input
                    type="text"
                    value={form.street}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative group">
                    <label className="block text-sm font-semibold text-slate-200 mb-2">PLZ & Stadt</label>
                    <input
                      type="text"
                      value={form.city}
                  ...
                  <div className="relative group">
                    <label className="block text-sm font-semibold text-slate-200 mb-2">Land</label>
                    <input
                      type="text"
                      value={form.country}
              ...
              <div className="mt-8 p-5 bg-gradient-to-r from-primary-cyan/5 to-primary-blue/5
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-300/70">
                    <span className="font-semibold text-white">Hinweis:</span> Die Social Media Links werden im Footer
