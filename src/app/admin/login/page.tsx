...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-admin-bg via-[#121212] to-admin-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Grid Pattern */}
        <div
          className="absolute inset-0 opacity-[0.02] opacity-[0.05] invert"
          style={{
      ...
      >
        ...
        {/* Glass Card */}
        <div className="relative bg-admin-surface/80 backdrop-blur-2xl rounded-[2rem] border border-white/10 shadow-2xl shadow-black/30 p-10">
          {/* Inner Highlight */}
          ...
          >
            <h1 className="text-3xl font-bold text-white mb-3 font-montserrat">
              Admin Portal
            </h1>
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0, scale: 1 }}
                className="p-4 rounded-2xl bg-red-900/20 border border-red-800/30"
              >
              ...
              <div className="relative group">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="relative w-full pl-12 pr-5 py-4 rounded-2xl bg-admin-surface-hover/50 border-2 border-white/10
                             focus:outline-none focus:border-primary-cyan focus:bg-admin-surface
                             transition-all duration-300 text-white placeholder:text-slate-400"
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-primary-cyan transition-colors duration-300 group"
            >
      ...
      <motion.div
        ...
        className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 text-xs text-slate-500"
      >
