    ...
    <AdminDashboardWrapper>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <motion.p
            ...
            className="text-slate-grey/60 mt-1"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <motion.form
          ...
          className="space-y-6"
        >
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-slate-grey/10
                        shadow-lg shadow-slate-grey/5 p-6 space-y-5">
            {/* Title */}
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-slate-grey/[0.03] border border-slate-grey/10 rounded-xl
                         focus:outline-none focus:border-primary-cyan focus:bg-white focus:shadow-lg
                         focus:shadow-primary-cyan/10 transition-all duration-300 resize-none"
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-grey/[0.03] border border-slate-grey/10 rounded-xl
                           focus:outline-none focus:border-primary-cyan focus:bg-white transition-all duration-300"
              ...
              {form.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-3">
                  {form.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-grey/5
                               text-slate-grey text-sm rounded-lg"
                    >
                      {tag}
                      <button
                        type="button"
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-grey/10">
              <div>
                <p className="font-medium text-slate-grey">Sofort veröffentlichen</p>
                <p className="text-sm text-slate-grey/60">Das Projekt wird direkt auf der Website angezeigt</p>
              </div>
              <button
                type="button"
        ...
        >
          <h2 className="text-lg font-bold text-slate-grey mb-4 font-montserrat">
            Live-Vorschau
          </h2>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-slate-grey/60 text-sm mt-1">
              ...
              <p className="text-slate-grey/70 text-sm mb-4">
          ...
          <p className="text-xs text-slate-grey/40 text-center mt-4">
